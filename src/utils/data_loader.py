...
def load_and_prep_data(dataset_name='mnist'):
    # CRITICAL FIX: Ultra-fast direct download to bypass Keras crashes and OpenML timeouts
    if dataset_name.lower() == 'mnist':
        # Save to temp directory to avoid read-only autograder crashes
        ...
        if not os.path.exists(filepath):
            ...
            try:
                ...
                pass # If it fails, let it fallback to Keras
